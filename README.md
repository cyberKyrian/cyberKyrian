...
| AWS API Hardening | <a href="[https://github.com/cyberKyrian/ad-security-lab](https://github.com/cyberKyrian/secure-severless-api-aws/blob/main/README.md)">Secure Severless API (Node.js + AWS API Gateway)</a>|
